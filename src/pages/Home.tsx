          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                Sambutan Pimpinan Pon-pes
              </h2>
              <div className="prose prose-lg text-slate-600">
                {settings?.sambutanPimpinanPonpes?.split('\n').map((paragraph, idx) => (
                ...
                <div className="flex items-center gap-4 mt-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Assalamu’alaikum Warahmatullahi Wabarakatuh.
                      Pondok Pesantren Darul Huda Al-ikhwan hadir sebagai ikhtiar mencetak generasi penerus yang tidak hanya cerdas secara intelektual, 
                      tetapi juga berakhlak mulia, mandiri, dan berpemahaman agama yang kokoh.
                      Kami memadukan kurikulum kepesantrenan modern dan pendidikan formal untuk menjawab tantangan zaman.
                      Mari percayakan pendidikan buah hati Anda bersama kami, menjadi bagian dari generasi yang qurrota a’yun, berbakti pada agama, bangsa, dan negara.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Ikuti langkah-langkah mudah berikut untuk mendaftarkan putra/putri Anda di Pondok Pesantren Darul Huda Al-ikhwan.
            </p>
          </div>
